              ...
              <tr key={order._id}>
                ...
                <td>
                  ...
                  <div style={{marginTop: '4px'}}>
                    <span style={{fontSize: '0.75rem', fontWeight: 600, padding: '0.15rem 0.4rem', borderRadius: '4px', background: order.paymentMethod === 'instapay' ? 'var(--color-accent-soft)' : 'var(--bg-elevated)', color: order.paymentMethod === 'instapay' ? 'var(--color-accent)' : 'var(--text-muted)'}}>
                      {order.paymentMethod === 'instapay' ? 'InstaPay' : 'COD'}
                    </span>
                  </div>
                  {order.paymentMethod === 'instapay' && order.instapayScreenshot && (
                    <div style={{marginTop: '8px'}}>
                      <a href={order.instapayScreenshot} target="_blank" rel="noopener noreferrer" style={{fontSize: '0.75rem', color: 'var(--info)', textDecoration: 'underline'}}>View Screenshot</a>
                    </div>
                  )}
                </td>
