...
export default function ChatWidget() {
  ...
  const [messages, setMessages] = useState(() => {
    try { return JSON.parse(sessionStorage.getItem('myou_chat')) || []; } catch { return []; }
  });
  ...
  useEffect(() => {
    sessionStorage.setItem('myou_chat', JSON.stringify(messages));
        ...
        <div className="chat-window">
          <div className="chat-header">
            <div className="chat-header-info">
              ...
              <div>
                <p className="chat-name">M You Assistant</p>
          ...
          <div className="chat-messages">
            {messages.length === 0 && (
              <div className="chat-welcome">
                ...
                <p>Hey! 👋 I'm your M You assistant. Ask me about products, sizes, shipping — anything!</p>
              </div>
            )}
            {messages.map((m, i) => (
