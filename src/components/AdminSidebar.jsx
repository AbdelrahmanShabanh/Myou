...
export default function AdminSidebar() {
  ...
  const links = [
    ...
    }, // Dashboard icon
    {
      to: "/admin/products",
      label: "Products",
      icon: "M18 10V6l-6-4-6 4v4H2v11h20V10zM12 4l4 2.67v2.66l-4-2.66-4 2.66V6.67L12 4zM4 12h16v7H4v-7z",
    }, // Box icon
    {
      to: "/admin/orders",
      label: "Orders",
      icon: "M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2m0 16H5V5h14v14M7 10h2v7H7zm4-3h2v10h-2zm4 6h2v4h-2z",
    }, // Analytics icon
    {
      to: "/admin/categories",
      label: "Categories",
  ...
  return (
    <aside className="admin-sidebar">
      ...
      <nav className="sidebar-nav">
        ...
        <button
          className="mobile-logout-btn sidebar-link"
