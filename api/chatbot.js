...
export default async function handler(req, res) {
  ...
  try {
    ...
    const systemPrompt = `You are a helpful assistant for M You, a men's streetwear clothing store based in Egypt.
...
If stock is 0, tell them it's currently out of stock.`;
    ...
    const chat = model.startChat({
      history: [
        ...
        { role: 'model', parts: [{ text: 'Understood! I\'m ready to help customers of M You.' }] },
        ...chatHistory
      ],
